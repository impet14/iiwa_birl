...
;//! \htmlinclude ConfigureSmartServo-request.msg.html

(cl:defclass <ConfigureSmartServo-request> (roslisp-msg-protocol:ros-message)
  ((control_mode
    :reader control_mode
...
(cl:defclass ConfigureSmartServo-request (<ConfigureSmartServo-request>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <ConfigureSmartServo-request>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'ConfigureSmartServo-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name iiwa_msgs-srv:<ConfigureSmartServo-request> is deprecated: use iiwa_msgs-srv:ConfigureSmartServo-request instead.")))

(cl:ensure-generic-function 'control_mode-val :lambda-list '(m))
(cl:defmethod control_mode-val ((m <ConfigureSmartServo-request>))
...
(cl:defmethod joint_impedance-val ((m <ConfigureSmartServo-request>))
...
(cl:defmethod cartesian_impedance-val ((m <ConfigureSmartServo-request>))
...
(cl:defmethod desired_force-val ((m <ConfigureSmartServo-request>))
...
(cl:defmethod sine_pattern-val ((m <ConfigureSmartServo-request>))
...
(cl:defmethod limits-val ((m <ConfigureSmartServo-request>))
  ...
  (limits m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ConfigureSmartServo-request>) ostream)
  "Serializes a message object of type '<ConfigureSmartServo-request>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ConfigureSmartServo-request>) istream)
  "Deserializes a message object of type '<ConfigureSmartServo-request>"
    (cl:let ((unsigned 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConfigureSmartServo-request>)))
  "Returns string type for a service object of type '<ConfigureSmartServo-request>"
  "iiwa_msgs/ConfigureSmartServoRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConfigureSmartServo-request)))
  "Returns string type for a service object of type 'ConfigureSmartServo-request"
  "iiwa_msgs/ConfigureSmartServoRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ConfigureSmartServo-request>)))
  "Returns md5sum for a message object of type '<ConfigureSmartServo-request>"
  "680a54772ae74cfe325dd171700c3d78")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ConfigureSmartServo-request)))
  "Returns md5sum for a message object of type 'ConfigureSmartServo-request"
  "680a54772ae74cfe325dd171700c3d78")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ConfigureSmartServo-request>)))
  "Returns full string definition for message of type '<ConfigureSmartServo-request>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ConfigureSmartServo-request)))
  "Returns full string definition for message of type 'ConfigureSmartServo-request"
  (cl:format cl:nil "~%~%~%int32 control_mode~%iiwa_msgs/JointImpedanceControlMode joint_impedance~%iiwa_msgs/CartesianImpedanceControlMode cartesian_impedance~%iiwa_msgs/DesiredForceControlMode desired_force~%iiwa_msgs/SinePatternControlMode sine_pattern~%iiwa_msgs/CartesianControlModeLimits limits~%~%================================================================================~%MSG: iiwa_msgs/JointImpedanceControlMode~%# Stiffness values in [Nm/rad]. Stiffness values must be >= 0. ~%JointQuantity joint_stiffness~%~%# Damping values. Damping values must be between 0 and 1. ~%JointQuantity joint_damping~%~%================================================================================~%MSG: iiwa_msgs/JointQuantity~%float32 a1~%float32 a2~%float32 a3~%float32 a4~%float32 a5~%float32 a6~%float32 a7~%================================================================================~%MSG: iiwa_msgs/CartesianImpedanceControlMode~%~%# Stiffness values [x, y, z, a, b, c] for the cartesian impedance, x, y, z in [N/m], a, b, c in [Nm/rad]. ~%# Precondition: 0.0 <= x, y, z <= 5000.0 and 0.0 <= a, b, c <= 300.0. ~%CartesianQuantity cartesian_stiffness~%~%# Dimensionless damping values for the cartesian impedance control, for all degrees of freedom : [x, y, z, a, b, c].~%# Precondition: 0.1 <= x, y, z, a, b, c <= 1.0. ~%CartesianQuantity cartesian_damping~%~%# The stiffness value for null space [Nm/rad]. ~%# Precondition: 0.0 <= value. ~%float64 nullspace_stiffness~%~%# The damping parameter for null space [Nm*s/rad]. ~%# Precondition: value >= 0.3 and value <= 1.0. - A good damping value is 0.7. ~%float64 nullspace_damping~%================================================================================~%MSG: iiwa_msgs/CartesianQuantity~%float32 x~%float32 y~%float32 z~%float32 a~%float32 b~%float32 c~%================================================================================~%MSG: iiwa_msgs/DesiredForceControlMode~%# The degree of freedom on which the desired force~%int32 cartesian_dof~%~%# The value of the desired force. In [N].~%float64 desired_force~%~%# The value of the stiffness. In [N/m].~%float64 desired_stiffness~%================================================================================~%MSG: iiwa_msgs/SinePatternControlMode~%# The degree of freedom for performing the sine oscillation.~%int32 cartesian_dof~%~%# The value of the frequency for the sine oscillation [Hz].~%float64 frequency~%~%# The value of the amplitude. In [N].~%float64 amplitude~%~%# The value of the stiffness. In [N/m].~%float64 stiffness~%================================================================================~%MSG: iiwa_msgs/CartesianControlModeLimits~%# Sets the maximum cartesian deviation accepted. If the deviation is exceeded a stop condition occurs. ~%# [x, y, z] in [mm]. Precondition: value > 0.0.~%# [a, b, c] in [rad]. Precondition: value > 0.0.~%CartesianQuantity max_path_deviation~%~%# The maximum control force parameter.~%# [x, y, z] in [N]. Precondition: value > 0.0.~%# [a, b, c] in [Nm]. Precondition: value > 0.0.~%CartesianQuantity max_control_force~%~%# Indicates whether a stop condition is fired if the maximum control force is exceeded. ~%bool max_control_force_stop~%~%# Maximum Cartesian velocity parameter ~%# [x, y, z] in [mm/s]. Precondition: value > 0.0.~%# [a, b, c] in [rad/s]. Precondition: value > 0.0.~%CartesianQuantity max_cartesian_velocity ~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ConfigureSmartServo-request>))
  (cl:+ 0
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ConfigureSmartServo-request>))
  "Converts a ROS message object to a list"
  (cl:list 'ConfigureSmartServo-request
...
;//! \htmlinclude ConfigureSmartServo-response.msg.html

(cl:defclass <ConfigureSmartServo-response> (roslisp-msg-protocol:ros-message)
  ((success
    :reader success
    :initarg :success
    :type cl:boolean
...
(cl:defclass ConfigureSmartServo-response (<ConfigureSmartServo-response>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <ConfigureSmartServo-response>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'ConfigureSmartServo-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name iiwa_msgs-srv:<ConfigureSmartServo-response> is deprecated: use iiwa_msgs-srv:ConfigureSmartServo-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <ConfigureSmartServo-response>))
...
(cl:defmethod error-val ((m <ConfigureSmartServo-response>))
  ...
  (error m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ConfigureSmartServo-response>) ostream)
  "Serializes a message object of type '<ConfigureSmartServo-response>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ConfigureSmartServo-response>) istream)
  "Deserializes a message object of type '<ConfigureSmartServo-response>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConfigureSmartServo-response>)))
  "Returns string type for a service object of type '<ConfigureSmartServo-response>"
  "iiwa_msgs/ConfigureSmartServoResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConfigureSmartServo-response)))
  "Returns string type for a service object of type 'ConfigureSmartServo-response"
  "iiwa_msgs/ConfigureSmartServoResponse")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ConfigureSmartServo-response>)))
  "Returns md5sum for a message object of type '<ConfigureSmartServo-response>"
  "680a54772ae74cfe325dd171700c3d78")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ConfigureSmartServo-response)))
  "Returns md5sum for a message object of type 'ConfigureSmartServo-response"
  "680a54772ae74cfe325dd171700c3d78")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ConfigureSmartServo-response>)))
  "Returns full string definition for message of type '<ConfigureSmartServo-response>"
  (cl:format cl:nil "bool success~%string error~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ConfigureSmartServo-response)))
  "Returns full string definition for message of type 'ConfigureSmartServo-response"
  (cl:format cl:nil "bool success~%string error~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ConfigureSmartServo-response>))
  (cl:+ 0
     1
     4 (cl:length (cl:slot-value msg 'error))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ConfigureSmartServo-response>))
  "Converts a ROS message object to a list"
  (cl:list 'ConfigureSmartServo-response
    (cl:cons ':success (success msg))
    (cl:cons ':error (error msg))
))
(cl:defmethod roslisp-msg-protocol:service-request-type ((msg (cl:eql 'ConfigureSmartServo)))
  'ConfigureSmartServo-request)
(cl:defmethod roslisp-msg-protocol:service-response-type ((msg (cl:eql 'ConfigureSmartServo)))
  'ConfigureSmartServo-response)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConfigureSmartServo)))
  "Returns string type for a service object of type '<ConfigureSmartServo>"
