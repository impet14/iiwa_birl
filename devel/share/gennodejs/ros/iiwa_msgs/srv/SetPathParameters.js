...
class SetPathParametersRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetPathParametersRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetPathParametersRequest
    let len;
    let data = new SetPathParametersRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetPathParametersRequest(null);
...
class SetPathParametersResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.success = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetPathParametersResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetPathParametersResponse
    let len;
    let data = new SetPathParametersResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetPathParametersResponse(null);
...
module.exports = {
  Request: SetPathParametersRequest,
  Response: SetPathParametersResponse,
  md5sum() { return '960e33fb145e93219db644650cd367e4'; },
  datatype() { return 'iiwa_msgs/SetPathParameters'; }
};
